...
namespace UniSimpleProfiler
{
    ...
    public sealed partial class UniSimpleProfilerUI : MonoBehaviour
    {
        ...
        //====================================================================================
        [SerializeField]
        private TextMeshProUGUI m_fpsTextUI = null;

        [SerializeField]
        private TextMeshProUGUI m_gcTextUI = null;

        [SerializeField]
        private TextMeshProUGUI m_monoUsedTextUI = null;

        [SerializeField]
        private TextMeshProUGUI m_monoTotalTextUI = null;

        [SerializeField]
        private TextMeshProUGUI m_unityUsedTextUI = null;

        [SerializeField]
        private TextMeshProUGUI m_unityTotalTextUI = null;
